...
def show_references():
    ...
    st.markdown(
        "<h2 style='font-size: 22px;'>2023 John Ashley Burgoyne and Janne Spijkervet and David John Baker,<p> \
    ...
    st.markdown(
        "<h2 style='font-size: 22px;'>2023 diamondsnake, <p> 'Eurovision Song Contest Data.' </h2>",
        unsafe_allow_html=True)
    st.link_button(url='https://www.kaggle.com/datasets/diamondsnake/eurovision-song-contest-data', label = 'Repository Link')

    st.markdown(
        "<h2 style='font-size: 22px;'>2025 Wikipedia, <p>"
    ...
    st.markdown(
        "<h2 style='font-size: 22px;'>Our somewhat sinister self-portrait was AI-generated by Ayla Abdullah.</h2>",
        unsafe_allow_html=True
    )
#empty spaces
