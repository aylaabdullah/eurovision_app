...
def show_references():
    ...
    st.markdown(
        "<h2 style='font-size: 18px;'>This app was made using Streamlit, Tableau, Python, Pandas, & nltk. </h2>",
        unsafe_allow_html=True
    )
    st.markdown(
        "<h2 style='font-size: 18px;'>Our somewhat sinister self-portrait was AI-generated by Ayla Abdullah.</h2>",
        unsafe_allow_html=True
    )
#empty spaces
